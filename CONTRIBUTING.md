NOTE: these have been copied from NMDC and may need adapted

For discussion on AI use see https://github.com/lambda-ber/lambda-ber-schema/issues/45

# Contributing to this schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to lambda-ber-schema. This guide
is aimed primarily at the core LAMBDA schema developers, although anyone is welcome
to contribute.
...
The lambda-ber-schema team strives to create a
...
Please use the [Issue Tracker](https://github.com/lambda-ber/lambda-ber-schema/issues/) for reporting problems with the schema. 
...
See [Pull Requests](https://github.com/lambda-ber/lambda-ber-schema/pulls/) for all pull requests.
...
- PRs should be reviewed and merged in a timely fashion by the lambda-ber-schema technical leads
...
- Include examples and counter-examples (intentionally invalid examples)
    ...
    - All elements of the lambda-ber-schema must be illustrated with valid and invalid data examples in src/data. New schema elements will not be merged into the main branch until examples are provided
