...
gh-add-topics:
  gh repo edit --add-topic "ai-gene-curation,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/ai4curation/ai-gene-curation/collaborators/dragon-ai-agent -X PUT -f permission=push
