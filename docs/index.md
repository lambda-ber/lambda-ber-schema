...
- [Experiment Runs](elements/ExperimentRun.md): Individual data collection sessions. An experiment run
...
**Logical Groupings**
- [Studies](elements/Study.md): Lightweight groupings representing focused investigations of specific
