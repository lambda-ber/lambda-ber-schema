...
```mermaid
 classDiagram
    ...
    click Instrument href "../Instrument/"
      ...
      Instrument : instrument_registry_id
...
| [instrument_registry_id](instrument_registry_id.md) | 0..1 <br/> [String](String.md)&nbsp;or&nbsp;<br />[BeamlineEnum](BeamlineEnum.md) | Controlled-vocabulary identifier linking this instrument to its canonical ent... | direct |
