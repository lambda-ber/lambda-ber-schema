 ...
 * [NamedThing](NamedThing.md) - A named thing
     ...
     * [Dataset](Dataset.md) - Root container holding flat entity collections and association tables. Follows relational database design patterns for structural biology data.
     ...
     * [Study](Study.md) - A logical grouping of related experiments investigating a research question. In the relational model, Study is lightweight - all relationships are via association tables.
 ...
 * [➞control_system](beamlineInstrument__control_system.md) - Low-level control system for device communication
 * [➞daq_system](beamlineInstrument__daq_system.md) - Data acquisition system used for experiment orchestration
 ...
 * [➞lims_system](beamlineInstrument__lims_system.md) - Laboratory Information Management System used at this beamline
 ...
 * [➞data_files](dataset__data_files.md) - All data files
 * [➞experiment_instrument_associations](dataset__experiment_instrument_associations.md) - Links between experiments and instruments (M:N)
 * [➞experiment_runs](dataset__experiment_runs.md) - All experiment runs (data collection sessions)
 * [➞experiment_sample_associations](dataset__experiment_sample_associations.md) - Links between experiments and samples (M:N with role)
 * [➞images](dataset__images.md) - All images
 * [➞instruments](dataset__instruments.md) - All instruments used across studies
 * [➞keywords](dataset__keywords.md) - Keywords or tags describing the dataset for search and categorization
 * [➞protein_constructs](dataset__protein_constructs.md) - All protein constructs
 * [➞sample_preparations](dataset__sample_preparations.md) - All sample preparations
 * [➞samples](dataset__samples.md) - All samples across all studies
 * [➞studies](dataset__studies.md) - All studies in this dataset
 * [➞study_experiment_associations](dataset__study_experiment_associations.md) - Links between studies and experiments (M:N)
 * [➞study_sample_associations](dataset__study_sample_associations.md) - Links between studies and samples (M:N)
 * [➞study_workflow_associations](dataset__study_workflow_associations.md) - Links between studies and workflows (M:N)
 * [➞workflow_experiment_associations](dataset__workflow_experiment_associations.md) - Links between workflows and source experiments (M:N)
 * [➞workflow_input_associations](dataset__workflow_input_associations.md) - Links between workflows and input files
 * [➞workflow_output_associations](dataset__workflow_output_associations.md) - Links between workflows and output files
 * [➞workflow_runs](dataset__workflow_runs.md) - All workflow runs (computational processing)
 ...
 * [➞experiment_id](experimentInstrumentAssociation__experiment_id.md) - Reference to the experiment run
 * [➞instrument_id](experimentInstrumentAssociation__instrument_id.md) - Reference to the instrument
 * [➞role](experimentInstrumentAssociation__role.md) - Role of instrument in experiment
 ...
 * [➞daq_system](experimentRun__daq_system.md) - Data acquisition system used to collect this experiment
 ...
 * [➞experiment_id](experimentSampleAssociation__experiment_id.md) - Reference to the experiment run
 * [➞preparation_id](experimentSampleAssociation__preparation_id.md) - Specific preparation used for this sample in this experiment
 * [➞role](experimentSampleAssociation__role.md) - Role of sample in experiment
 * [➞sample_id](experimentSampleAssociation__sample_id.md) - Reference to the sample
 ...
 * [numeric_value](numeric_value.md) - The numerical part of a quantity value, expressed as a number.
     * [QuantityValue➞numeric_value](QuantityValue_numeric_value.md) - The numerical value of the quantity. May be null if the value is unknown or not measured.
 ...
 * [➞oligomeric_state](sample__oligomeric_state.md) - Oligomeric state of the sample (e.g., monomer, dimer, tetramer, hexamer)
 ...
 * [➞experiment_id](studyExperimentAssociation__experiment_id.md) - Reference to the experiment run
 * [➞study_id](studyExperimentAssociation__study_id.md) - Reference to the study
 * [➞date_added](studySampleAssociation__date_added.md) - Date when sample was added to study
 * [➞role](studySampleAssociation__role.md) - Role of sample in study (e.g., target, control, reference)
 * [➞sample_id](studySampleAssociation__sample_id.md) - Reference to the sample
 * [➞study_id](studySampleAssociation__study_id.md) - Reference to the study
 * [➞study_id](studyWorkflowAssociation__study_id.md) - Reference to the study
 * [➞workflow_id](studyWorkflowAssociation__workflow_id.md) - Reference to the workflow run
 * [➞keywords](study__keywords.md) - Keywords or tags describing the study for search and categorization
 ...
 * [➞experiment_id](workflowExperimentAssociation__experiment_id.md) - Reference to the source experiment run
 * [➞workflow_id](workflowExperimentAssociation__workflow_id.md) - Reference to the workflow run
 * [➞file_id](workflowInputAssociation__file_id.md) - Reference to the input data file
 * [➞input_type](workflowInputAssociation__input_type.md) - Type of input for the workflow
 * [➞workflow_id](workflowInputAssociation__workflow_id.md) - Reference to the workflow run
 * [➞file_id](workflowOutputAssociation__file_id.md) - Reference to the output data file
 * [➞output_type](workflowOutputAssociation__output_type.md) - Type of output from the workflow
 * [➞workflow_id](workflowOutputAssociation__workflow_id.md) - Reference to the workflow run
 ...
 * [BeamlineEnum](BeamlineEnum.md) - Specific beamline instances at DOE and other major structural biology facilities
 ...
 * [ControlSystemEnum](ControlSystemEnum.md) - Low-level control systems and middleware frameworks for device communication and hardware abstraction at experimental facilities. These provide the foundation layer that data acquisition systems build upon.
 * [CrystallizationMethodEnum](CrystallizationMethodEnum.md) - Methods for protein crystallization
 * [DataAcquisitionSystemEnum](DataAcquisitionSystemEnum.md) - Data acquisition (DAQ) systems for orchestrating experimental data collection at facilities. These systems coordinate hardware, execute scan sequences, and stream data and metadata during experiments.
 ...
 * [LIMSSystemEnum](LIMSSystemEnum.md) - Laboratory Information Management Systems (LIMS) used at structural biology facilities to manage samples, experiments, and data workflows. These systems track samples from shipment through data collection and processing.
